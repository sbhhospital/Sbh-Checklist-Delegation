...
//       const allDelegationData = [] // NEW: Store all delegation data for submission status lookup
...
//         // Map all columns (including L and M for submission status)
//         for (let i = 0; i < 18; i++) {
//           if (i === 0 || i === 6 || i === 10) {
//             rowData[`col${i}`] = rowValues[i] ? parseGoogleSheetsDate(String(rowValues[i])) : ""
//           } else {
...
//         // NEW: Store all delegation data for submission status lookup
...
//       setDelegationData(allDelegationData) // NEW: Store all delegation data
//       setLoading(false)
//     } catch (error) {
                    ...
                    filteredAccountData.map((account) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <td className="px-6 py-4 whitespace-nowrap">
                            <div className="text-sm text-gray-900">{account["col20"] || "—"}</div>
                          </td>
                        </tr>
                      )
                    })
